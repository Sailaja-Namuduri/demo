...
export const DataCard=({image,cardtitle,carddescription})=>{
    ...
    return(
        <>
            <div className="d-none d-md-block col-md-6 col-lg-6 align-center" style={{border:'0px solid green',padding:'20px',height:'540px',width:'540px'}}>
            ...
            <div className="d-sm-block d-md-none col-sm-6 align-center" style={{border:'0px solid green',padding:'20px',height:'240px',width:'240px'}}>
